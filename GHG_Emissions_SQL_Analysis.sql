...
---- Top 10 countries with the highest percentage increase in emissions from 1991-2021--- 

---- Compare emissions between 1991 and 2021----- 
WITH Emissions_1991 AS (
	SELECT 
		Country, 
		SUM(Emissions) AS Emissions_1991
...
SELECT TOP 10
	e91.Country,
	ROUND(e91.Emissions_1991,2) AS Emissions_1991,
	ROUND(e21.Emissions_2021,2) AS Emissions_2021,
	ROUND(
	((e21.Emissions_2021 -e91.Emissions_1991)/e91.Emissions_1991)*100,2) AS Percentage_Increase

FROM Emissions_1991 e91

JOIN Emissions_2021 e21
ON e91.Country = e21.Country

WHERE e91.Emissions_1991 > 0

ORDER BY Percentage_Increase DESC;


--- Top 10 countries with a significant decrease in emissions from 1991-2021---
...
SELECT TOP 10
	...
	ROUND(e91.Emissions_1991,2) AS Emissions_1991,
	ROUND(e21.Emissions_2021,2) AS Emissions_2021,
	ROUND(e91.Emissions_1991 - e21.Emissions_2021,2) AS Emission_Reduction
FROM Emissions_1991 e91

JOIN Emissions_2021 e21
ON e91.Country = e21.COUNTRY

WHERE e21.Emissions_2021 < e91.Emissions_1991
